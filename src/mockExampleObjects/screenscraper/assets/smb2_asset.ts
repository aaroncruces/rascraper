...
export const smb2ExpectedAssets: Assets = {
  ...
  snapURL:
    "https://clone.screenscraper.fr/api2/mediaJeu.php?devid=aaroncio&devpassword=j5OdeaTg5JF&softname=rascraper&ssid=&sspassword=&systemeid=3&jeuid=1248&media=ss(eu)",
  snapCRC: "820ef993",
  titleURL:
    "https://clone.screenscraper.fr/api2/mediaJeu.php?devid=aaroncio&devpassword=j5OdeaTg5JF&softname=rascraper&ssid=&sspassword=&systemeid=3&jeuid=1248&media=sstitle(eu)",
  titleCRC: "ba2cf258",
  boxartURL:
